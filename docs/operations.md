...
`fathom-data-schema-forge` is centered on data engineering work in C++. The technical target is: Build a C++ toolkit that studies schema behavior through framed sample traffic, with bounds and ordering tests and fixture-scale datasets.
...
The score is deterministic. The current threshold is 154. Risk has a penalty of 7, latency has a penalty of 3, and weight contributes a bonus of 4.
