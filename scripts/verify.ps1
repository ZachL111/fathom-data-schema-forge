...
powershell -NoProfile -ExecutionPolicy Bypass -File scripts/check-fathom-data-schema-detail.ps1
...
powershell -NoProfile -ExecutionPolicy Bypass -File scripts/check-fathom-data-schema-properties.ps1
if ($LASTEXITCODE -ne 0) { exit $LASTEXITCODE }

powershell -NoProfile -ExecutionPolicy Bypass -File scripts/check-fathom-data-schema-golden.ps1
if ($LASTEXITCODE -ne 0) { exit $LASTEXITCODE }

powershell -NoProfile -ExecutionPolicy Bypass -File scripts/check-fathom_data_schema_forge-casebook.ps1
if ($LASTEXITCODE -ne 0) { exit $LASTEXITCODE }
