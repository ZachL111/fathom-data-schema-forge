...
$repo = "fathom-data-schema-forge"
$language = "C++"
$category = "Data engineering"

foreach ($path in @("metadata/domain-review.json", "config/review-profile.json", "fixtures/domain_review.csv", "docs/field-notes.md", "docs/review-journal.md", "examples/fathom-data-schema-walkthrough.md")) {
