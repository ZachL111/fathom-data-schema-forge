"""Regression checks for the fathom-data-schema-forge casebook."""
...
from casebook.harness import assert_expected, fathom_data_schema_forge_summary
...
class CasebookTests(unittest.TestCase):
    ...
    def test_named_summary_alias(self) -> None:
        self.assertEqual(fathom_data_schema_forge_summary(), assert_expected())
